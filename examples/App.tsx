...
const pgnPartial = `[Event ""] [Site ""] [StartAtPly "5"] [EndAtPly "20"] [Date "1997.02.15"] [EventDate "1997.02.04"] [Round "10"] [Result "0-1"] [White "Magnus Carlsen"] [Black "Fabiano Caruana"] [ECO "B90"] [WhiteElo "?"] [BlackElo "?"] [PlyCount "76"] 1.e4 e5 2.Bc4 Nf6 3.d3 c6 4.Nf3 d5 5.Bb3 Bb4+ 6.c3 Bd6 7.Bg5 dxe4 8.dxe4 h6 9.Bh4 Qe7 10.Nbd2 Nbd7 11.Bg3 Bc7 12.O-O Nh5 13.h3 Nxg3 14.fxg3 Nc5 15.Bxf7+ Kxf7 16.Nxe5+ Kg8 17.Ng6 Qg5 18.Rf8+ Kh7 19.Nxh8 Bg4 20.Qf1 Nd3 21.Qxd3 Rxf8 22.hxg4 Qxg4 23.Nf3 Qxg3 24.e5+ Kxh8 25.e6 Bb6+ 26.Kh1 Qg4 27.Qd6 Rd8 28.Qe5 Rd5 29.Qb8+ Kh7 30.e7 Qh5+ 31.Nh2 Rd1+ 32.Rxd1 Qxd1+ 33.Nf1 Qxf1+ 34.Kh2 Qg1+ 0-1`;

const App: React.FC = () => {
  const handleHighlight = useCallback((node: Element) => {
    try {
    ...
    <div className="container">
      <div className="row">
        <div className="col-xs-12">
          <h2 style={headerStyles}>Processed HTML content</h2>
          <PgnViewer
            nodeToModify={'pre code'}
            nodeModification={handleHighlight}
            innerHtml={true}
          >
            {`<pre class="language-javascript"><code>function foo { return bar }</code></pre><pgn>${pgnFull}</pgn>`}
          </PgnViewer>
          <h2 style={headerStyles}>Full PGN</h2>
          <PgnViewer orientation="black" width={500}>
            {pgnFull}
          </PgnViewer>
          <h2 style={headerStyles}>Using StartAtPly</h2>
          <PgnViewer orientation="black" width={500}>
            {pgnPartial}
          </PgnViewer>
        </div>
